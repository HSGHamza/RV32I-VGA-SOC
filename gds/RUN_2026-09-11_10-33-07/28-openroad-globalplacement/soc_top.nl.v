module soc_top (Hsync,
 ...
 sky130_fd_sc_hd__inv_2 _0405_ (.A(s0_axi_bvalid),
    .Y(_0191_));
 sky130_fd_sc_hd__inv_2 _0406_ (.A(pcRegister[29]),
    .Y(_0192_));
 sky130_fd_sc_hd__inv_2 _0407_ (.A(pcRegister[16]),
    .Y(_0193_));
 sky130_fd_sc_hd__inv_2 _0408_ (.A(pcRegister[15]),
    .Y(_0194_));
 ...
 sky130_fd_sc_hd__inv_2 _0417_ (.A(\u_vga_controller.H_count[0] ),
    .Y(_0018_));
 sky130_fd_sc_hd__inv_2 _0418_ (.A(reset),
    .Y(_0038_));
 ...
 sky130_fd_sc_hd__or4_2 _0454_ (.A(\u_vga_controller.H_count[13] ),
    ...
    .X(_0235_));
 sky130_fd_sc_hd__nor4_2 _0455_ (.A(_0231_),
    .B(_0233_),
    .C(_0234_),
    .D(_0235_),
    .Y(_0236_));
 ...
 sky130_fd_sc_hd__nor3_2 _0478_ (.A(_0250_),
    ...
    .C(_0252_),
    .Y(_0253_));
 sky130_fd_sc_hd__nand2_2 _0479_ (.A(_0236_),
    .B(_0253_),
    .Y(_0254_));
 ...
 sky130_fd_sc_hd__and3_2 _0607_ (.A(\u_vga_controller.H_count[5] ),
    ...
    .C(_0230_),
    .X(_0328_));
 sky130_fd_sc_hd__nor3_2 _0608_ (.A(_0236_),
    .B(_0327_),
    .C(_0328_),
    .Y(_0029_));
 ...
 sky130_fd_sc_hd__and4_2 _0614_ (.A(\u_vga_controller.H_count[7] ),
    ...
    .D(_0328_),
    .X(_0332_));
 sky130_fd_sc_hd__nor3_2 _0615_ (.A(_0236_),
    .B(_0331_),
    .C(_0332_),
    .Y(_0032_));
 ...
 sky130_fd_sc_hd__a21boi_2 _0642_ (.A1(\u_axi_decoder.unmapped_rvalid_reg ),
    ...
    .Y(_0000_));
 sky130_fd_sc_hd__a21oi_2 _0643_ (.A1(pcRegister[2]),
    .A2(_0316_),
    .B1(reset),
    .Y(_0346_));
 sky130_fd_sc_hd__o21a_2 _0644_ (.A1(pcRegister[2]),
    .A2(_0316_),
    .B1(_0346_),
    .X(_0120_));
 sky130_fd_sc_hd__a21oi_2 _0645_ (.A1(pcRegister[2]),
    .A2(_0316_),
    .B1(pcRegister[3]),
    .Y(_0347_));
 sky130_fd_sc_hd__a31o_2 _0646_ (.A1(pcRegister[3]),
    .A2(pcRegister[2]),
    .A3(_0316_),
    .B1(reset),
    .X(_0348_));
 sky130_fd_sc_hd__nor2_2 _0647_ (.A(_0347_),
    .B(_0348_),
    .Y(_0121_));
 sky130_fd_sc_hd__a31oi_2 _0648_ (.A1(pcRegister[3]),
    .A2(pcRegister[2]),
    .A3(_0316_),
    .B1(pcRegister[4]),
    .Y(_0349_));
 sky130_fd_sc_hd__and4_2 _0649_ (.A(pcRegister[4]),
    .B(pcRegister[3]),
    .C(pcRegister[2]),
    .D(_0316_),
    .X(_0350_));
 sky130_fd_sc_hd__nor3_2 _0650_ (.A(reset),
    .B(_0349_),
    .C(_0350_),
    .Y(_0122_));
 sky130_fd_sc_hd__and4_2 _0651_ (.A(pcRegister[5]),
    .B(pcRegister[4]),
    .C(pcRegister[3]),
    .D(pcRegister[2]),
    .X(_0351_));
 sky130_fd_sc_hd__and2_2 _0652_ (.A(_0316_),
    .B(_0351_),
    .X(_0352_));
 sky130_fd_sc_hd__nor2_2 _0653_ (.A(reset),
    .B(_0352_),
    .Y(_0353_));
 sky130_fd_sc_hd__o21a_2 _0654_ (.A1(pcRegister[5]),
    .A2(_0350_),
    .B1(_0353_),
    .X(_0123_));
 sky130_fd_sc_hd__a21oi_2 _0655_ (.A1(pcRegister[6]),
    .A2(_0352_),
    .B1(reset),
    .Y(_0354_));
 sky130_fd_sc_hd__o21a_2 _0656_ (.A1(pcRegister[6]),
    .A2(_0352_),
    .B1(_0354_),
    .X(_0124_));
 sky130_fd_sc_hd__a21oi_2 _0657_ (.A1(pcRegister[6]),
    .A2(_0352_),
    .B1(pcRegister[7]),
    .Y(_0355_));
 sky130_fd_sc_hd__and3_2 _0658_ (.A(pcRegister[7]),
    .B(pcRegister[6]),
    .C(_0352_),
    .X(_0356_));
 sky130_fd_sc_hd__nor3_2 _0659_ (.A(reset),
    .B(_0355_),
    .C(_0356_),
    .Y(_0125_));
 sky130_fd_sc_hd__and4_2 _0660_ (.A(pcRegister[8]),
    .B(pcRegister[7]),
    .C(pcRegister[6]),
    .D(_0352_),
    .X(_0357_));
 sky130_fd_sc_hd__nor2_2 _0661_ (.A(reset),
    .B(_0357_),
    .Y(_0358_));
 sky130_fd_sc_hd__o21a_2 _0662_ (.A1(pcRegister[8]),
    .A2(_0356_),
    .B1(_0358_),
    .X(_0126_));
 sky130_fd_sc_hd__nor2_2 _0663_ (.A(pcRegister[9]),
    .B(_0357_),
    .Y(_0359_));
 sky130_fd_sc_hd__and4_2 _0664_ (.A(pcRegister[9]),
    .B(pcRegister[8]),
    .C(pcRegister[7]),
    .D(pcRegister[6]),
    .X(_0360_));
 sky130_fd_sc_hd__and3_2 _0665_ (.A(_0316_),
    ...
    .C(_0360_),
    .X(_0361_));
 sky130_fd_sc_hd__nor3_2 _0666_ (.A(reset),
    .B(_0359_),
    .C(_0361_),
    .Y(_0127_));
 sky130_fd_sc_hd__o21ai_2 _0667_ (.A1(pcRegister[10]),
    .A2(_0361_),
    .B1(_0038_),
    .Y(_0362_));
 sky130_fd_sc_hd__a21oi_2 _0668_ (.A1(pcRegister[10]),
    .A2(_0361_),
    .B1(_0362_),
    .Y(_0128_));
 sky130_fd_sc_hd__a21oi_2 _0669_ (.A1(pcRegister[10]),
    .A2(_0361_),
    .B1(pcRegister[11]),
    .Y(_0363_));
 sky130_fd_sc_hd__and3_2 _0670_ (.A(pcRegister[11]),
    .B(pcRegister[10]),
    .C(_0361_),
    .X(_0364_));
 sky130_fd_sc_hd__nor3_2 _0671_ (.A(reset),
    .B(_0363_),
    .C(_0364_),
    .Y(_0129_));
 sky130_fd_sc_hd__and3_2 _0672_ (.A(pcRegister[12]),
    .B(pcRegister[11]),
    .C(pcRegister[10]),
    .X(_0365_));
 sky130_fd_sc_hd__nand2_2 _0673_ (.A(_0361_),
    .B(_0365_),
    .Y(_0366_));
 sky130_fd_sc_hd__o211a_2 _0674_ (.A1(pcRegister[12]),
    .A2(_0364_),
    .B1(_0366_),
    .C1(_0038_),
    .X(_0130_));
 sky130_fd_sc_hd__a21oi_2 _0675_ (.A1(_0361_),
    ...
    .B1(pcRegister[13]),
    .Y(_0367_));
 sky130_fd_sc_hd__and3_2 _0676_ (.A(pcRegister[13]),
    .B(_0361_),
    .C(_0365_),
    .X(_0368_));
 sky130_fd_sc_hd__nor3_2 _0677_ (.A(reset),
    .B(_0367_),
    .C(_0368_),
    .Y(_0131_));
 sky130_fd_sc_hd__and2_2 _0678_ (.A(pcRegister[14]),
    .B(pcRegister[13]),
    .X(_0369_));
 sky130_fd_sc_hd__nand4_2 _0679_ (.A(_0351_),
    ...
    .D(_0369_),
    .Y(_0370_));
 sky130_fd_sc_hd__or2_2 _0680_ (.A(cpu_stall),
    .B(_0370_),
    .X(_0371_));
 sky130_fd_sc_hd__and4_2 _0681_ (.A(_0351_),
    ...
    .D(_0369_),
    .X(_0372_));
 sky130_fd_sc_hd__o211a_2 _0682_ (.A1(pcRegister[14]),
    .A2(_0368_),
    .B1(_0371_),
    .C1(_0038_),
    .X(_0132_));
 sky130_fd_sc_hd__and3_2 _0683_ (.A(pcRegister[15]),
    .B(_0316_),
    .C(_0372_),
    .X(_0373_));
 sky130_fd_sc_hd__a21o_2 _0684_ (.A1(_0194_),
    ...
    .B1(_0373_),
    .X(_0374_));
 sky130_fd_sc_hd__nor2_2 _0685_ (.A(reset),
    .B(_0374_),
    .Y(_0133_));
 sky130_fd_sc_hd__a2111oi_2 _0686_ (.A1(_0314_),
    ...
    .D1(_0193_),
    .Y(_0375_));
 sky130_fd_sc_hd__nor2_2 _0687_ (.A(reset),
    .B(_0375_),
    .Y(_0376_));
 sky130_fd_sc_hd__o21a_2 _0688_ (.A1(pcRegister[16]),
    .A2(_0373_),
    .B1(_0376_),
    .X(_0134_));
 sky130_fd_sc_hd__nor2_2 _0689_ (.A(pcRegister[17]),
    .B(_0375_),
    .Y(_0377_));
 sky130_fd_sc_hd__and3_2 _0690_ (.A(pcRegister[17]),
    .B(pcRegister[16]),
    .C(_0373_),
    .X(_0378_));
 sky130_fd_sc_hd__nor3_2 _0691_ (.A(reset),
    .B(_0377_),
    .C(_0378_),
    .Y(_0135_));
 sky130_fd_sc_hd__a31o_2 _0692_ (.A1(pcRegister[18]),
    .A2(pcRegister[17]),
    .A3(_0375_),
    .B1(reset),
    .X(_0379_));
 sky130_fd_sc_hd__o21ba_2 _0693_ (.A1(pcRegister[18]),
    .A2(_0378_),
    .B1_N(_0379_),
    .X(_0136_));
 sky130_fd_sc_hd__a21oi_2 _0694_ (.A1(pcRegister[18]),
    .A2(_0378_),
    .B1(pcRegister[19]),
    .Y(_0380_));
 sky130_fd_sc_hd__and4_2 _0695_ (.A(pcRegister[19]),
    .B(pcRegister[18]),
    .C(pcRegister[17]),
    .D(_0375_),
    .X(_0381_));
 sky130_fd_sc_hd__nor3_2 _0696_ (.A(reset),
    .B(_0380_),
    .C(_0381_),
    .Y(_0137_));
 sky130_fd_sc_hd__a21oi_2 _0697_ (.A1(pcRegister[20]),
    .A2(_0381_),
    .B1(reset),
    .Y(_0382_));
 sky130_fd_sc_hd__o21a_2 _0698_ (.A1(pcRegister[20]),
    .A2(_0381_),
    .B1(_0382_),
    .X(_0138_));
 sky130_fd_sc_hd__a21oi_2 _0699_ (.A1(pcRegister[20]),
    .A2(_0381_),
    .B1(pcRegister[21]),
    .Y(_0383_));
 sky130_fd_sc_hd__and3_2 _0700_ (.A(pcRegister[21]),
    .B(pcRegister[20]),
    .C(_0381_),
    .X(_0384_));
 sky130_fd_sc_hd__nor3_2 _0701_ (.A(reset),
    .B(_0383_),
    .C(_0384_),
    .Y(_0139_));
 sky130_fd_sc_hd__and4_2 _0702_ (.A(pcRegister[22]),
    .B(pcRegister[21]),
    .C(pcRegister[20]),
    .D(_0381_),
    .X(_0385_));
 sky130_fd_sc_hd__nor2_2 _0703_ (.A(reset),
    .B(_0385_),
    .Y(_0386_));
 sky130_fd_sc_hd__o21a_2 _0704_ (.A1(pcRegister[22]),
    .A2(_0384_),
    .B1(_0386_),
    .X(_0140_));
 sky130_fd_sc_hd__a21oi_2 _0705_ (.A1(pcRegister[23]),
    .A2(_0385_),
    .B1(reset),
    .Y(_0387_));
 sky130_fd_sc_hd__o21a_2 _0706_ (.A1(pcRegister[23]),
    .A2(_0385_),
    .B1(_0387_),
    .X(_0141_));
 sky130_fd_sc_hd__a21oi_2 _0707_ (.A1(pcRegister[23]),
    .A2(_0385_),
    .B1(pcRegister[24]),
    .Y(_0388_));
 sky130_fd_sc_hd__and3_2 _0708_ (.A(pcRegister[24]),
    .B(pcRegister[23]),
    .C(_0385_),
    .X(_0389_));
 sky130_fd_sc_hd__nor3_2 _0709_ (.A(reset),
    .B(_0388_),
    .C(_0389_),
    .Y(_0142_));
 sky130_fd_sc_hd__and4_2 _0710_ (.A(pcRegister[25]),
    .B(pcRegister[24]),
    .C(pcRegister[23]),
    .D(_0385_),
    .X(_0390_));
 sky130_fd_sc_hd__nor2_2 _0711_ (.A(reset),
    .B(_0390_),
    .Y(_0391_));
 sky130_fd_sc_hd__o21a_2 _0712_ (.A1(pcRegister[25]),
    .A2(_0389_),
    .B1(_0391_),
    .X(_0143_));
 sky130_fd_sc_hd__a21oi_2 _0713_ (.A1(pcRegister[26]),
    .A2(_0390_),
    .B1(reset),
    .Y(_0392_));
 sky130_fd_sc_hd__o21a_2 _0714_ (.A1(pcRegister[26]),
    .A2(_0390_),
    .B1(_0392_),
    .X(_0144_));
 sky130_fd_sc_hd__a21oi_2 _0715_ (.A1(pcRegister[26]),
    .A2(_0390_),
    .B1(pcRegister[27]),
    .Y(_0393_));
 sky130_fd_sc_hd__a31o_2 _0716_ (.A1(pcRegister[27]),
    .A2(pcRegister[26]),
    .A3(_0390_),
    .B1(reset),
    .X(_0394_));
 sky130_fd_sc_hd__nor2_2 _0717_ (.A(_0393_),
    .B(_0394_),
    .Y(_0145_));
 sky130_fd_sc_hd__a31o_2 _0718_ (.A1(pcRegister[27]),
    .A2(pcRegister[26]),
    .A3(_0390_),
    .B1(pcRegister[28]),
    .X(_0395_));
 sky130_fd_sc_hd__and3_2 _0719_ (.A(pcRegister[28]),
    .B(pcRegister[27]),
    .C(pcRegister[26]),
    .X(_0396_));
 sky130_fd_sc_hd__nand2_2 _0720_ (.A(_0390_),
    .B(_0396_),
    .Y(_0397_));
 sky130_fd_sc_hd__and3_2 _0721_ (.A(_0038_),
    ...
    .C(_0397_),
    .X(_0146_));
 sky130_fd_sc_hd__a31o_2 _0722_ (.A1(pcRegister[29]),
    .A2(_0390_),
    .A3(_0396_),
    .B1(reset),
    .X(_0398_));
 sky130_fd_sc_hd__a21oi_2 _0723_ (.A1(_0192_),
    ...
    .B1(_0398_),
    .Y(_0147_));
 sky130_fd_sc_hd__a31o_2 _0724_ (.A1(pcRegister[29]),
    .A2(_0390_),
    .A3(_0396_),
    .B1(pcRegister[30]),
    .X(_0399_));
 sky130_fd_sc_hd__and2_2 _0725_ (.A(pcRegister[30]),
    .B(pcRegister[29]),
    .X(_0400_));
 sky130_fd_sc_hd__a31o_2 _0726_ (.A1(_0390_),
    .A2(_0396_),
    .A3(_0400_),
    .B1(reset),
    .X(_0401_));
 sky130_fd_sc_hd__and2b_2 _0727_ (.A_N(_0401_),
    .B(_0399_),
    .X(_0148_));
 sky130_fd_sc_hd__nand4_2 _0728_ (.A(pcRegister[31]),
    .B(_0390_),
    .C(_0396_),
    .D(_0400_),
    .Y(_0402_));
 ...
 sky130_fd_sc_hd__and3_2 _0730_ (.A(_0038_),
    ...
    .C(_0403_),
    .X(_0149_));
 sky130_fd_sc_hd__inv_2 _0731_ (.A(reset),
    .Y(_0039_));
 sky130_fd_sc_hd__inv_2 _0732_ (.A(reset),
    .Y(_0040_));
 sky130_fd_sc_hd__inv_2 _0733_ (.A(reset),
    .Y(_0041_));
 sky130_fd_sc_hd__inv_2 _0734_ (.A(reset),
    .Y(_0042_));
 sky130_fd_sc_hd__inv_2 _0735_ (.A(reset),
    .Y(_0043_));
 sky130_fd_sc_hd__inv_2 _0736_ (.A(reset),
    .Y(_0044_));
 sky130_fd_sc_hd__inv_2 _0737_ (.A(reset),
    .Y(_0045_));
 sky130_fd_sc_hd__inv_2 _0738_ (.A(reset),
    .Y(_0046_));
 sky130_fd_sc_hd__inv_2 _0739_ (.A(reset),
    .Y(_0047_));
 sky130_fd_sc_hd__inv_2 _0740_ (.A(reset),
    .Y(_0048_));
 sky130_fd_sc_hd__inv_2 _0741_ (.A(reset),
    .Y(_0049_));
 sky130_fd_sc_hd__inv_2 _0742_ (.A(reset),
    .Y(_0050_));
 sky130_fd_sc_hd__inv_2 _0743_ (.A(reset),
    .Y(_0051_));
 sky130_fd_sc_hd__inv_2 _0744_ (.A(reset),
    .Y(_0052_));
 sky130_fd_sc_hd__inv_2 _0745_ (.A(reset),
    .Y(_0053_));
 sky130_fd_sc_hd__inv_2 _0746_ (.A(reset),
    .Y(_0054_));
 sky130_fd_sc_hd__inv_2 _0747_ (.A(reset),
    .Y(_0055_));
 sky130_fd_sc_hd__inv_2 _0748_ (.A(reset),
    .Y(_0056_));
 sky130_fd_sc_hd__inv_2 _0749_ (.A(reset),
    .Y(_0057_));
 sky130_fd_sc_hd__inv_2 _0750_ (.A(reset),
    .Y(_0058_));
 sky130_fd_sc_hd__inv_2 _0751_ (.A(reset),
    .Y(_0059_));
 sky130_fd_sc_hd__inv_2 _0752_ (.A(reset),
    .Y(_0060_));
 sky130_fd_sc_hd__inv_2 _0753_ (.A(reset),
    .Y(_0061_));
 sky130_fd_sc_hd__inv_2 _0754_ (.A(reset),
    .Y(_0062_));
 sky130_fd_sc_hd__inv_2 _0755_ (.A(reset),
    .Y(_0063_));
 sky130_fd_sc_hd__inv_2 _0756_ (.A(reset),
    .Y(_0064_));
 sky130_fd_sc_hd__inv_2 _0757_ (.A(reset),
    .Y(_0065_));
 sky130_fd_sc_hd__inv_2 _0758_ (.A(reset),
    .Y(_0066_));
 sky130_fd_sc_hd__inv_2 _0759_ (.A(reset),
    .Y(_0067_));
 sky130_fd_sc_hd__inv_2 _0760_ (.A(reset),
    .Y(_0068_));
 sky130_fd_sc_hd__inv_2 _0761_ (.A(reset),
    .Y(_0069_));
 sky130_fd_sc_hd__inv_2 _0762_ (.A(reset),
    .Y(_0070_));
 sky130_fd_sc_hd__inv_2 _0763_ (.A(reset),
    .Y(_0071_));
 sky130_fd_sc_hd__inv_2 _0764_ (.A(reset),
    .Y(_0072_));
 sky130_fd_sc_hd__inv_2 _0765_ (.A(reset),
    .Y(_0073_));
 sky130_fd_sc_hd__inv_2 _0766_ (.A(reset),
    .Y(_0074_));
 sky130_fd_sc_hd__inv_2 _0767_ (.A(reset),
    .Y(_0075_));
 sky130_fd_sc_hd__inv_2 _0768_ (.A(reset),
    .Y(_0076_));
 sky130_fd_sc_hd__inv_2 _0769_ (.A(reset),
    .Y(_0077_));
 sky130_fd_sc_hd__inv_2 _0770_ (.A(reset),
    .Y(_0078_));
 sky130_fd_sc_hd__inv_2 _0771_ (.A(reset),
    .Y(_0079_));
 sky130_fd_sc_hd__inv_2 _0772_ (.A(reset),
    .Y(_0080_));
 sky130_fd_sc_hd__inv_2 _0773_ (.A(reset),
    .Y(_0081_));
 sky130_fd_sc_hd__inv_2 _0774_ (.A(reset),
    .Y(_0082_));
 sky130_fd_sc_hd__inv_2 _0775_ (.A(reset),
    .Y(_0083_));
 sky130_fd_sc_hd__inv_2 _0776_ (.A(reset),
    .Y(_0084_));
 sky130_fd_sc_hd__inv_2 _0777_ (.A(reset),
    .Y(_0085_));
 sky130_fd_sc_hd__inv_2 _0778_ (.A(reset),
    .Y(_0086_));
 sky130_fd_sc_hd__inv_2 _0779_ (.A(reset),
    .Y(_0087_));
 sky130_fd_sc_hd__inv_2 _0780_ (.A(reset),
    .Y(_0088_));
 sky130_fd_sc_hd__inv_2 _0781_ (.A(reset),
    .Y(_0089_));
 sky130_fd_sc_hd__inv_2 _0782_ (.A(reset),
    .Y(_0090_));
 sky130_fd_sc_hd__inv_2 _0783_ (.A(reset),
    .Y(_0091_));
 sky130_fd_sc_hd__inv_2 _0784_ (.A(reset),
    .Y(_0092_));
 sky130_fd_sc_hd__inv_2 _0785_ (.A(reset),
    .Y(_0093_));
 sky130_fd_sc_hd__inv_2 _0786_ (.A(reset),
    .Y(_0094_));
 sky130_fd_sc_hd__inv_2 _0787_ (.A(reset),
    .Y(_0095_));
 sky130_fd_sc_hd__inv_2 _0788_ (.A(reset),
    .Y(_0096_));
 sky130_fd_sc_hd__inv_2 _0789_ (.A(reset),
    .Y(_0097_));
 sky130_fd_sc_hd__inv_2 _0790_ (.A(reset),
    .Y(_0098_));
 sky130_fd_sc_hd__inv_2 _0791_ (.A(reset),
    .Y(_0099_));
 sky130_fd_sc_hd__inv_2 _0792_ (.A(reset),
    .Y(_0100_));
 sky130_fd_sc_hd__inv_2 _0793_ (.A(reset),
    .Y(_0101_));
 sky130_fd_sc_hd__inv_2 _0794_ (.A(reset),
    .Y(_0102_));
 sky130_fd_sc_hd__inv_2 _0795_ (.A(reset),
    .Y(_0103_));
 sky130_fd_sc_hd__inv_2 _0796_ (.A(reset),
    .Y(_0104_));
 sky130_fd_sc_hd__inv_2 _0797_ (.A(reset),
    .Y(_0105_));
 sky130_fd_sc_hd__inv_2 _0798_ (.A(reset),
    .Y(_0106_));
 sky130_fd_sc_hd__inv_2 _0799_ (.A(reset),
    .Y(_0107_));
 sky130_fd_sc_hd__inv_2 _0800_ (.A(reset),
    .Y(_0108_));
 sky130_fd_sc_hd__inv_2 _0801_ (.A(reset),
    .Y(_0109_));
 sky130_fd_sc_hd__inv_2 _0802_ (.A(reset),
    .Y(_0110_));
 sky130_fd_sc_hd__inv_2 _0803_ (.A(reset),
    .Y(_0111_));
 sky130_fd_sc_hd__inv_2 _0804_ (.A(reset),
    .Y(_0112_));
 sky130_fd_sc_hd__inv_2 _0805_ (.A(reset),
    .Y(_0113_));
 sky130_fd_sc_hd__inv_2 _0806_ (.A(reset),
    .Y(_0114_));
 sky130_fd_sc_hd__inv_2 _0807_ (.A(reset),
    .Y(_0115_));
 sky130_fd_sc_hd__inv_2 _0808_ (.A(reset),
    .Y(_0116_));
 sky130_fd_sc_hd__inv_2 _0809_ (.A(reset),
    .Y(_0117_));
 sky130_fd_sc_hd__inv_2 _0810_ (.A(reset),
    .Y(_0118_));
 ...
 sky130_fd_sc_hd__dfstp_2 _0921_ (.CLK(clk),
    ...
    .SET_B(_0118_),
    .Q(Vsync));
 sky130_fd_sc_hd__conb_1 _0922_ (.LO(blue[0]));
 sky130_fd_sc_hd__conb_1 _0923_ (.LO(blue[1]));
 sky130_fd_sc_hd__conb_1 _0924_ (.LO(blue[2]));
 sky130_fd_sc_hd__conb_1 _0925_ (.LO(blue[3]));
 sky130_fd_sc_hd__conb_1 _0926_ (.LO(blue[4]));
 sky130_fd_sc_hd__conb_1 _0927_ (.LO(blue[5]));
 sky130_fd_sc_hd__conb_1 _0928_ (.LO(blue[6]));
 sky130_fd_sc_hd__conb_1 _0929_ (.LO(blue[7]));
 sky130_fd_sc_hd__conb_1 _0930_ (.LO(display_enable));
 sky130_fd_sc_hd__conb_1 _0931_ (.LO(green[0]));
 sky130_fd_sc_hd__conb_1 _0932_ (.LO(green[1]));
 sky130_fd_sc_hd__conb_1 _0933_ (.LO(green[2]));
 sky130_fd_sc_hd__conb_1 _0934_ (.LO(green[3]));
 sky130_fd_sc_hd__conb_1 _0935_ (.LO(green[4]));
 sky130_fd_sc_hd__conb_1 _0936_ (.LO(green[5]));
 sky130_fd_sc_hd__conb_1 _0937_ (.LO(green[6]));
 sky130_fd_sc_hd__conb_1 _0938_ (.LO(green[7]));
 sky130_fd_sc_hd__conb_1 _0939_ (.LO(mem_addr[0]));
 sky130_fd_sc_hd__conb_1 _0940_ (.LO(mem_addr[1]));
 sky130_fd_sc_hd__conb_1 _0941_ (.LO(mem_addr[2]));
 sky130_fd_sc_hd__conb_1 _0942_ (.LO(mem_addr[3]));
 sky130_fd_sc_hd__conb_1 _0943_ (.LO(mem_addr[4]));
 sky130_fd_sc_hd__conb_1 _0944_ (.LO(mem_addr[5]));
 sky130_fd_sc_hd__conb_1 _0945_ (.LO(mem_addr[6]));
 sky130_fd_sc_hd__conb_1 _0946_ (.LO(mem_addr[7]));
 sky130_fd_sc_hd__conb_1 _0947_ (.LO(mem_addr[8]));
 sky130_fd_sc_hd__conb_1 _0948_ (.LO(mem_addr[9]));
 sky130_fd_sc_hd__conb_1 _0949_ (.LO(mem_addr[10]));
 sky130_fd_sc_hd__conb_1 _0950_ (.LO(mem_addr[11]));
 sky130_fd_sc_hd__conb_1 _0951_ (.LO(mem_addr[12]));
 sky130_fd_sc_hd__conb_1 _0952_ (.LO(mem_addr[13]));
 sky130_fd_sc_hd__conb_1 _0953_ (.LO(mem_addr[14]));
 sky130_fd_sc_hd__conb_1 _0954_ (.LO(mem_addr[15]));
 sky130_fd_sc_hd__conb_1 _0955_ (.LO(mem_addr[16]));
 sky130_fd_sc_hd__conb_1 _0956_ (.LO(mem_addr[17]));
 sky130_fd_sc_hd__conb_1 _0957_ (.LO(mem_addr[18]));
 sky130_fd_sc_hd__conb_1 _0958_ (.LO(mem_addr[19]));
 sky130_fd_sc_hd__conb_1 _0959_ (.LO(mem_addr[20]));
 sky130_fd_sc_hd__conb_1 _0960_ (.LO(mem_addr[21]));
 sky130_fd_sc_hd__conb_1 _0961_ (.LO(mem_addr[22]));
 sky130_fd_sc_hd__conb_1 _0962_ (.LO(mem_addr[23]));
 sky130_fd_sc_hd__conb_1 _0963_ (.LO(mem_addr[24]));
 sky130_fd_sc_hd__conb_1 _0964_ (.LO(mem_addr[25]));
 sky130_fd_sc_hd__conb_1 _0965_ (.LO(mem_addr[26]));
 sky130_fd_sc_hd__conb_1 _0966_ (.LO(mem_addr[27]));
 sky130_fd_sc_hd__conb_1 _0967_ (.LO(mem_addr[28]));
 sky130_fd_sc_hd__conb_1 _0968_ (.LO(mem_addr[29]));
 sky130_fd_sc_hd__conb_1 _0969_ (.LO(mem_addr[30]));
 sky130_fd_sc_hd__conb_1 _0970_ (.LO(mem_addr[31]));
 sky130_fd_sc_hd__conb_1 _0971_ (.LO(mem_read));
 sky130_fd_sc_hd__conb_1 _0972_ (.LO(mem_wdata[0]));
 sky130_fd_sc_hd__conb_1 _0973_ (.LO(mem_wdata[1]));
 sky130_fd_sc_hd__conb_1 _0974_ (.LO(mem_wdata[2]));
 sky130_fd_sc_hd__conb_1 _0975_ (.LO(mem_wdata[3]));
 sky130_fd_sc_hd__conb_1 _0976_ (.LO(mem_wdata[4]));
 sky130_fd_sc_hd__conb_1 _0977_ (.LO(mem_wdata[5]));
 sky130_fd_sc_hd__conb_1 _0978_ (.LO(mem_wdata[6]));
 sky130_fd_sc_hd__conb_1 _0979_ (.LO(mem_wdata[7]));
 sky130_fd_sc_hd__conb_1 _0980_ (.LO(mem_wdata[8]));
 sky130_fd_sc_hd__conb_1 _0981_ (.LO(mem_wdata[9]));
 sky130_fd_sc_hd__conb_1 _0982_ (.LO(mem_wdata[10]));
 sky130_fd_sc_hd__conb_1 _0983_ (.LO(mem_wdata[11]));
 sky130_fd_sc_hd__conb_1 _0984_ (.LO(mem_wdata[12]));
 sky130_fd_sc_hd__conb_1 _0985_ (.LO(mem_wdata[13]));
 sky130_fd_sc_hd__conb_1 _0986_ (.LO(mem_wdata[14]));
 sky130_fd_sc_hd__conb_1 _0987_ (.LO(mem_wdata[15]));
 sky130_fd_sc_hd__conb_1 _0988_ (.LO(mem_wdata[16]));
 sky130_fd_sc_hd__conb_1 _0989_ (.LO(mem_wdata[17]));
 sky130_fd_sc_hd__conb_1 _0990_ (.LO(mem_wdata[18]));
 sky130_fd_sc_hd__conb_1 _0991_ (.LO(mem_wdata[19]));
 sky130_fd_sc_hd__conb_1 _0992_ (.LO(mem_wdata[20]));
 sky130_fd_sc_hd__conb_1 _0993_ (.LO(mem_wdata[21]));
 sky130_fd_sc_hd__conb_1 _0994_ (.LO(mem_wdata[22]));
 sky130_fd_sc_hd__conb_1 _0995_ (.LO(mem_wdata[23]));
 sky130_fd_sc_hd__conb_1 _0996_ (.LO(mem_wdata[24]));
 sky130_fd_sc_hd__conb_1 _0997_ (.LO(mem_wdata[25]));
 sky130_fd_sc_hd__conb_1 _0998_ (.LO(mem_wdata[26]));
 sky130_fd_sc_hd__conb_1 _0999_ (.LO(mem_wdata[27]));
 sky130_fd_sc_hd__conb_1 _1000_ (.LO(mem_wdata[28]));
 sky130_fd_sc_hd__conb_1 _1001_ (.LO(mem_wdata[29]));
 sky130_fd_sc_hd__conb_1 _1002_ (.LO(mem_wdata[30]));
 sky130_fd_sc_hd__conb_1 _1003_ (.LO(mem_wdata[31]));
 sky130_fd_sc_hd__conb_1 _1004_ (.LO(mem_write));
 sky130_fd_sc_hd__conb_1 _1005_ (.LO(pcRegister[0]));
 sky130_fd_sc_hd__conb_1 _1006_ (.LO(pcRegister[1]));
 sky130_fd_sc_hd__conb_1 _1007_ (.LO(red[0]));
 sky130_fd_sc_hd__conb_1 _1008_ (.LO(red[1]));
 sky130_fd_sc_hd__conb_1 _1009_ (.LO(red[2]));
 sky130_fd_sc_hd__conb_1 _1010_ (.LO(red[3]));
 sky130_fd_sc_hd__conb_1 _1011_ (.LO(red[4]));
 sky130_fd_sc_hd__conb_1 _1012_ (.LO(red[5]));
 sky130_fd_sc_hd__conb_1 _1013_ (.LO(red[6]));
 sky130_fd_sc_hd__conb_1 _1014_ (.LO(red[7]));
endmodule
